...
handlers.accountCreate = (data, callback) => {
    if(data.method == 'get') {
        let templateData = {
            ...
            'head.description' : 'Sign Up takes few seconds!',
...
handlers.sessionCreate = (data, callback) => {
    if(data.method == 'get') {
        let templateData = {
            'head.title' : 'Log In',
            'head.description' : 'Please Enter Phone and Password to access account',
...
handlers.accountDeleted = (data, callback) => {
    if(data.method == 'get') {
        let templateData = {
            ...
            'head.description' : 'Your account has been successfully deleted!',
...
handlers.checkCreate = (data, callback) => {
    if(data.method == 'get') {
        ...
        helpers.getTemplate('checkCreate', templateData, (err, str) => {
            if (!err && str) {
                helpers.addUniversalTemplates(str, templateData, (err, fullStr) => {
                    if (!err && fullStr) {
                        callback(200, fullStr, 'html');
